...
SnowB, Figma/PSD, UI Prefab, Lumen, and reference-resource write integrations are not native Core capabilities and remain private paid-support integrations.
