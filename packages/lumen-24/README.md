...
npm run --workspace @peanut/cocos-lumen-24 bundle:templates

# 自定义 Resources 根
COCOS_CREATOR_24_RESOURCES=/path/to/CocosCreator.app/Contents/Resources npm run --workspace @peanut/cocos-lumen-24 bundle:templates
```

**不**修改、不 import `@peanut/cocos-lumen` / `peanut.lumen`。
