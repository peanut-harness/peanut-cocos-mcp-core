...
给 MCP / 自动化 Agent 用的最短操作手册。权威契约见 [`@peanut/cocos-lumen` README](../../../tools/lumen/README.md)。产品线（stable / early3x / creator2x）门禁与双消化器对照：[LUMEN-PRODUCT-LINE-PARITY.json](./LUMEN-PRODUCT-LINE-PARITY.json)。
