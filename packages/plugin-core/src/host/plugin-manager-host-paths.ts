/**
 * @description 根据 `peanut-plugin-core` 包根目录解析默认热更新监听路径。
 * @param packageRootDir `peanut-plugin-core` 包根目录
 * @returns 建议监听的目录路径列表
 */
...
/**
 * @description 根据拆分后的 `peanut-plugin-core` 与 `peanut-plugin-panel` 包根目录解析默认热更新监听路径。
 * @param corePackageRootDir `peanut-plugin-core` 包根目录
 * @param panelPackageRootDir `peanut-plugin-panel` 包根目录
 * @returns 建议监听的目录路径列表
 */
