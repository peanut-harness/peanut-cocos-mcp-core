...
import { PackagingApp, type IInstalledPackageRecord, type IInstalledPackageSnapshot, type IPluginFileStorageSummary, type IPackageSnapshot, type PluginConfig, type PluginSettingsScope, type ProjectPluginFileStore } from 'peanut-packaging';
import type { ICocosRuntime, IExecutionDiagnosticsSnapshot } from 'peanut-runtime';
